    ...
    TextWriter output)
{
    ...
    public string StateDirectory => Path.GetFullPath(GetOption("--state") ??
        Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "Mainframe"));
